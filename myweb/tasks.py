...
def start():
    ...
    job_schedule = [
        (my_cron_task_getAndSave_index_list, 22, 35, "my_cron_task_getAndSave_index_list", "인덱스 리스트 수집 (약 1분)"),
        (my_cron_task_getAndSave_stock_description, 22, 40, "my_cron_task_getAndSave_stock_description", "주식 설명 수집 (약 5분)"),
        (my_cron_task_getAndSave_index_data, 22, 45, "my_cron_task_getAndSave_index_data", "인덱스 데이터 수집 (약 10분)"),
        (my_cron_task_getAndSave_stock_data, 22, 55, "my_cron_task_getAndSave_stock_data", "주식 OHLCV 데이터 수집 (약 20분)"),
        (my_cron_task_calculate_stock_analysis, 23, 15, "my_cron_task_calculate_stock_analysis", "주식 기술적 분석 계산 (약 10분)"),
        (my_cron_task_getAndSave_stock_dartData, 23, 30, "my_cron_task_getAndSave_stock_dartData", "DART 데이터 수집 (약 1시간 30분)"),
