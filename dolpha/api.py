...
@api.get("/find_stock_index", response={200: SuccessResponseStockIndexSchema, 404: ErrorResponse, 500: ErrorResponse})
...
@api.get("/find_index_ohlcv", response={200: SuccessResponseIndexOhlcvSchema, 404: ErrorResponse, 500: ErrorResponse})
